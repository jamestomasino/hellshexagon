...
test('knownness-to-flame conversion uses expected 1-5 buckets', () => {
  ...
  assert.equal(knownnessToFlames(0.50), 1)
  assert.equal(knownnessToFlames(0.49), 2)
  assert.equal(knownnessToFlames(0.43), 2)
  assert.equal(knownnessToFlames(0.42), 3)
  assert.equal(knownnessToFlames(0.35), 3)
  assert.equal(knownnessToFlames(0.34), 4)
  assert.equal(knownnessToFlames(0.24), 4)
  assert.equal(knownnessToFlames(0.23), 5)
